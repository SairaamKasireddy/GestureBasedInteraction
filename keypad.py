...
class Window(QMainWindow):
	...
	def __init__(self):
		...
		self.setGeometry(50, 50, 380, 430)
		self.UiComponents()
		self.show()

	def UiComponents(self):
		self.label.setGeometry(5, 5, 370, 80)
